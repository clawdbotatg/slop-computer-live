...
// Three-bar speed hierarchy: ticker 120s, headlines 115s, timeline
// 110s. Headlines is barely faster than the prices, distinctly
// slower than the timeline above it.
const SCROLL_DURATION_S = 115;
